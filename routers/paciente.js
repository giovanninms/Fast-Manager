...
// PacienteSchema.findOneAndUpdate({_id: "6634d89147281dbc185ea3e4"}, updatePaciente).then((paciente)=>{
//     console.log(`Paciente: ${paciente.nome} atualizado para ${updatePaciente.nome}`)
// }).catch((error)=>{
